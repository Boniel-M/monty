...
void rotate_stack_left(stack_t **stack,  __attribute__((unused)) unsigned int lineNum);
void rotate_stack_right(stack_t **stack, __attribute__((unused)) unsigned int lineNum);
